        ...
        <nav class="bg-gray-100 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600 shadow">
            <div class="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="flex md:order-2">
                    <a href="{{ route('subscriptions.index', ['subscription_id' => 2]) }}" class="hidden md:block text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-md md:text-sm lg:text-lg px-4 py-2 text-center md:mr-3 w-28">
                        Login
                    </a>
